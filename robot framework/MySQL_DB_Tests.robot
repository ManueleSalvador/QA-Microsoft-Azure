...
Execute SQL Script - Insert Data person table
    ...
    ${output} =    Execute SQL Script    C:\\Users\\Manuele\\AppData\\Local\\Programs\\Python\\Python39\\Lib\\site-packages\\Robotframework-Database-Library-master\\test\\my_db_test_insertData.sql
    Log    ${output}
    Should Be Equal As Strings    ${output}    None
...
Verify Query - Get results as a list of dictionaries
    ...
    Log    ${output}
    Log    ${output[0]}[first_name]
    Log    ${output[1]}[first_name]
